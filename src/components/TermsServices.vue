          ...
          <div class="content-section">
            ...
            <section>
              ...
              <div class="clause-list">
                ...
                <div class="clause-item">
                  <strong>3.3</strong> The Supplier shall be entitled to charge Statutory Interest on overdue invoices from the date when payment becomes due until payment is made. In the event that the Customer's procedures require that an invoice be submitted against a purchase order for payment, the Customer shall be responsible for issuing such purchase order before the services and Deliverables are supplied.
                </div>
                 <div class="clause-item">
                  <strong>3.4</strong> If the Customer fails to make any payment when due, the Supplier may suspend performance of the services and/or delivery of the Deliverables until such payment is made.
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="clause-list">
                ...
                <div class="clause-item">
                  <strong>5.5</strong> The Deliverables shall be deemed accepted on the earliest of:
                  <div class="sub-clause-list">
                    <div class="sub-clause-item"><strong>5.5.1</strong> the Customer confirming acceptance in writing; or</div>
                    <div class="sub-clause-item"><strong>5.5.2</strong> the Customer using the Deliverables in a live or production environment; or</div>
                    <div class="sub-clause-item"><strong>5.5.3</strong> the expiry of the applicable Acceptance Period without the Customer having notified any material non-conformities in accordance with clause 5.3.</div>                   
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="clause-list">
                <div class="clause-item">
                  <strong>7.1</strong> To enable the Supplier to perform its obligations under this Agreement the Customer shall:
                  <div class="sub-clause-list">
                  ...
                  <strong>7.3</strong> Without prejudice to any other rights to which the Supplier may be entitled, in the event that the Customer cancels or terminates the services and/or Deliverables set out in the Statement of Work other than in accordance with clause 12, the Customer shall pay to the Supplier:
                      <div class="sub-clause-list">
                        ...
                        <div class="sub-clause-item"><strong>7.3.3</strong> a cancellation fee calculated as a percentage of the remaining fees that would have been payable under the Statement of Work, as follows:</div>
                          ...
                          <div class="sub-clause-item"><strong>iii.</strong> where written notice of cancellation is given less than 10 Business Days before the next scheduled milestone or delivery date: 50% of the remaining fees.</div>                        

                  <div class="clause-item">
                  <strong>7.3.4</strong> The parties agree that the sums payable under this clause 7.3 represent a genuine pre-estimate of the Supplier’s likely loss and are not a penalty.
                </div>              
                   <div class="clause-item">
                  <strong>7.3.5</strong> For the avoidance of doubt, where the Customer commits a material breach of its obligations under clause 7.1 which prevents the Supplier from performing the services and fails to remedy such breach within 5 working days of receiving written notice from the Supplier, the Supplier shall be entitled to treat this as a cancellation by the Customer for the purposes of this clause 7.3.
                </div>   
                </div>            
                </div>
                </div>
                <div class="clause-item">
                  <strong>7.4</strong> In the event that the Customer or any third party, not being a sub-contractor of the Supplier, shall omit or commit anything which prevents or delays the Supplier from undertaking or complying with any of its obligations under this Agreement, then the Supplier shall notify the Customer as soon as possible and:
                  <div class="sub-clause-list">
                    <div class="sub-clause-item"><strong>7.4.1</strong> the Supplier shall have no liability in respect of any delay to the completion of any project;</div>
                    <div class="sub-clause-item"><strong>7.4.2</strong> if applicable, the timetable for the project will be modified accordingly;</div>
                    <div class="sub-clause-item"><strong>7.4.3</strong> the Supplier shall notify the Customer at the same time if it intends to make any claim for additional costs.</div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="sub-clause-list">
                ...
                <div class="clause-item">
                  <strong>9.3</strong> The Supplier warrants that the services performed under this Agreement shall be performed using reasonable skill and care and in accordance with generally accepted industry standards and practices.
                </div>
                   <div class="clause-item">
                  <strong>9.4</strong>  Remedy: The Supplier’s sole obligation and the Customer’s exclusive remedy for any breach of the warranty in clause 9.1 shall be, at the Supplier’s option, to:
              <div class="sub-clause-list">
                    <div class="sub-clause-item"><strong>9.4.1</strong> use reasonable efforts to correct the non-conformity; or</div>
                    <div class="sub-clause-item"><strong>9.4.2</strong> provide a reasonable workaround; or</div>
                    <div class="sub-clause-item"><strong>9.4.3</strong> where the non-conformity cannot reasonably be remedied, refund the charges paid by the Customer for the part of the Software that is materially affected.</div>
                  </div>
                </div>
                               <div class="clause-item">
                  <strong>9.5</strong> The Customer must notify the Supplier in writing of any alleged breach of the warranty in clause 9.1 within the Warranty Period. If the Customer fails to do so, the Supplier shall have no obligation to remedy such breach under clause 9.4.
                </div>
                               <div class="clause-item">
                  <strong>9.6</strong> Following expiry of the Warranty Period, any support, maintenance, bug fixes, updates or modifications to the Software shall be provided only under a separate support or maintenance agreement (if any) or, in the absence of such an agreement, shall be chargeable at the Supplier’s then current rates.
                </div>
                               <div class="clause-item">
                  <strong>9.7</strong> Except as expressly stated in this Agreement, all warranties, conditions and other terms, whether express or implied, by statute, common law or otherwise, are excluded to the fullest extent permitted by law in relation to the Software, Deliverables and services provided by the Supplier.
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="clause-list">
                ...
                <div class="clause-item">
                  <strong>11.3</strong> Nothing in these Terms and Conditions shall exclude or limit the Supplier's liability for death or personal injury resulting from the Supplier's negligence or that of its employees, agents or sub-contractors.
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="clause-list">
                <div class="clause-item">
                  <strong>12.1</strong> the other party commits a material breach of this Agreement and, in the case of a breach capable of being remedied, fails to remedy it within 30 calendar days of being given written notice from the other party to do so;
                </div>
                <div class="clause-item">
                  <strong>12.2</strong> the other party commits a material breach of this Agreement which cannot be remedied under any circumstances;
                </div>
                <div class="clause-item">
                  <strong>12.3</strong> the other party passes a resolution for winding up (other than for the purpose of solvent amalgamation or reconstruction), or a court of competent jurisdiction makes an order to that effect;
                </div>
                <div class="clause-item">
                  <strong>12.4</strong> the other party ceases to carry on its business or substantially the whole of its business; or
                </div>
                <div class="clause-item">
                  <strong>12.5</strong> the other party is declared insolvent, or convenes a meeting of or makes or proposes to make any arrangement or composition with its creditors; or a liquidator, receiver, administrative receiver, manager, trustee or similar officer is appointed over any of its assets.
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="clause-list">
                <div class="clause-item">
                  <strong>13.1</strong>  In this Agreement:
                                <div class="sub-clause-list">
                    <div class="sub-clause-item"><strong>(a)</strong> "Supplier Background IPR" means all Intellectual Property Rights owned by or licensed to the Supplier prior to the Effective Date of this Agreement or developed independently of this Agreement, including without limitation any tools, engines, frameworks, libraries,  templates, design systems, processes and know-how;</div>
                    <div class="sub-clause-item"><strong>(b)</strong> "Customer Materials" means all materials, content, data, brand assets, trademarks, logos, text, images, audio, video and other information supplied by or on behalf of the Customer to the Supplier for the purposes of this Agreement; and</div>
                    <div class="sub-clause-item"><strong>(c)</strong> "Deliverables IPR" means all Intellectual Property Rights in the Deliverables (excluding any Supplier Background IPR and any Customer Materials).</div>
                  </div>
                </div>
                <div class="clause-item">
                ...
                <div class="clause-item">
                  <strong>13.4</strong> The Customer shall ensure that it has obtained all rights, licences and consents necessary for the Supplier to use the Customer Materials in accordance with clause 13.3 and shall indemnify the Supplier against any claims by third parties arising from the Supplier’s authorised use of the Customer Materials.
                </div>
                <div class="clause-item">
                  <strong>13.5</strong> Nothing in this Agreement shall prevent the Supplier from using any general ideas, concepts, know-how or techniques acquired or used in the course of providing the services, provided that the Supplier does not use the Customer’s Confidential Information or Customer Materials in doing so.
                </div>
                <div class="clause-item">
                  <strong>13.6</strong> The Customer’s rights to use the Deliverables IPR are limited to the licence granted in clause 6 and subject always to the terms of this Agreement.
                </div>
              </div>
            </section>
            ...
            <section>
              <h3>17. ASSIGNMENT</h3>
              <div class="clause-item">
                  <strong>17.1</strong> The Customer shall not assign, transfer or delegate any of its rights or obligations under this Agreement (including the licence granted in clause 6) without the prior written consent of the Supplier.
                </div>
                  <div class="clause-item">
                  <strong>17.2</strong> Notwithstanding clause 17.1, the Customer may assign its rights under this Agreement (including the licence granted in clause 6) to a third party that acquires all or substantially all of the Customer’s business or assets to which the Deliverables relate, provided that:
                <div class="sub-clause-list">
                    <div class="sub-clause-item"><strong>17.2.1</strong> the Customer gives the Supplier written notice of the assignment as soon as reasonably practicable; and</div>
                    <div class="sub-clause-item"><strong>17.2.2</strong> the assignee agrees in writing to be bound by the terms of this Agreement in place of the Customer.</div>
                  </div>
                </div>
                  <div class="clause-item">
                  <strong>17.3</strong> The Supplier may assign or transfer its rights and obligations under this Agreement to any member of its group or in connection with any merger, acquisition or sale of all or part of its business, provided it notifies the Customer.
                </div>
            </section>
